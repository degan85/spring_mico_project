...
Blockly.Blocks['running_object'] = {
    init: function() {
        this.appendStatementInput("running_blocks")
            ...
            .appendField(new Blockly.FieldDropdown([[{"src":"/img/girl.png","width":50,"height":50,"alt":"girl"},"girl"],[{"src":"/img/cloud.png","width":50,"height":50,"alt":"cloud"},"cloud"]]), "running_object_pic");
